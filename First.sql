...
CREATE TABLE OrderCustomer
	(IdOrderCustomer int PRIMARY KEY NOT NULL,
...
CREATE TABLE SupplierType
	(IdSupplierType int PRIMARY KEY NOT NULL,
...
CREATE TABLE SemiFinishedOrder
	(IdSfOrder int PRIMARY KEY NOT NULL,
...
CREATE TABLE SfOrderDetail
	(IdSfDetail int PRIMARY KEY NOT NULL,
...
CREATE TABLE OutsourcingType
	(IdOutsourcingType int PRIMARY KEY NOT NULL,
	OutsourcingType nvarchar(50) NOT NULL);

CREATE TABLE Outsourcing
	(IdOutsourcing int PRIMARY KEY NOT NULL,
...
CREATE TABLE OutsourcingCommitment
	(IdCommitment int PRIMARY KEY NOT NULL,
...
alter table EnteranceControl add constraint FKSfDetail foreign key (IdSfDetail) references SfOrderDetail(IdSfDetail);
alter table EnteranceControl add constraint FKEnteranceControlEmployee foreign key (IdEmployee) references Employee(IdEmployee);
...
--ALTER TABLE SemiFinishedOrder ADD CONSTRAINT SemiFinishedOrderSemifinished FOREIGN KEY (IdSemiFinished) REFERENCES SemiFinished (IdSemiFinished);
...
ALTER TABLE Failures ADD CONSTRAINT FKProductionProces
FOREIGN KEY (IdProces) REFERENCES ProductionProces(IdProces)
/*
ALTER TABLE Failures ADD CONSTRAINT FKFailuresMaintenance
FOREIGN KEY (IdFailure) REFERENCES FailureMaintenance(IdFailure)
